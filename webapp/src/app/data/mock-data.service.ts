...
import { mockApiResource, mockApiResource2, mockApiResourceWithNulls, mockDocument52, mockDocument53, mockUser, mockProfessionalResource, mockDocument54, mockDocument55, mockApiAccessStrategyResource, mockApiFormativeStrategyResource } from './mock-data';
...
export class MockDataService implements PublicPart<DataService> {
  readonly mockGetDataEndpoints = [
    ...
    { pattern: /\/resources\/5$/, result: mockApiFormativeStrategyResource },
