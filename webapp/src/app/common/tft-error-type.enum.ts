...
export const errorMessages: Map<TftErrorType, TftErrorMessage>  = new Map([
  [TftErrorType.AuthNoAppAccess, {
    ...
    message: 'It looks like your user is not configured with access to the Tools for Teachers application. Please contact support@smarterbalanced.org for assistance.'
  }],
